...
LSI_accuracy = MNB_train.score(test_LSI_array, test_data_catorgory)
...
NMF_accuracy = MNB_train.score(test_NMF_array, test_data_catorgory)
test_score = MNB_train.predict_proba(test_NMF_array)
MNB_test_NMF_FPR, MNB_test_NMF_TPR, MNB_MNB_thresholds = roc_curve(test_data_catorgory, test_score[:,1])
